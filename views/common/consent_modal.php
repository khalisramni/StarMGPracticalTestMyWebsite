<!-- Privacy Consent Modal (hidden by default) -->
<div id="consent-box" class="position-fixed bottom-0 start-0 w-100 bg-dark text-white p-4 d-none" style="z-index: 1050;">
